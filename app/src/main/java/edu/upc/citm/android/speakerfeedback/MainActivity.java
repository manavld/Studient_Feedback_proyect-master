...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startFirestoreLisenerService();
    }
    private  void startFirestoreLisenerService(){
        Intent intent = new Intent(this,FireStoreLisenerService.class);
        intent.putExtra("room", "testroom");
        startService(intent);
    }

    private  void stopFirestoreLisenerService(){
    Intent intent = new Intent(this, FireStoreLisenerService.class);
    stopService(intent);
    }
    ...
    private EventListener<QuerySnapshot> usersListener = new EventListener<QuerySnapshot>() {
        ...
        public void onEvent(QuerySnapshot documentSnapshots, FirebaseFirestoreException e) {
            ...
            users_conected.setText(String.format("Users Conected : %d", documentSnapshots.size()));
    ...
    class ViewHolder extends  RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            answers_view = itemView.findViewById(R.id.answers_view);
    ...
    class Adapter extends  RecyclerView.Adapter<ViewHolder>{
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            if (position == 0)
            {
                ...
                if (poll.isOpen())
                {
                    holder.status_view.setText("Active");
                }
                else
                {
                    holder.status_view.setText("Previous");
                }
            }
            else
            {
            ...
            holder.answers_view.setText(poll.getOptionsAsString());
        }
